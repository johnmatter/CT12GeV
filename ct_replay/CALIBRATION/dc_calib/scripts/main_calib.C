...
int main_calib()
{
  ...
  //DC_calib obj("SHMS", "../../../ROOTfiles/shms_replay_production_1791_0_-1.root", 1791, -1, "pid_kFALSE","card");
  DC_calib obj("HMS", "../../../ROOTfiles/hms_replay_production_1267_0_-1.root",1267,-1 , "pid_elec","card");
