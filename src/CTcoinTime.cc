...
void CTcoinTime(Int_t runNumber,  TString shms_particle, Int_t analyzedEvents)
{
    ...
    //tree->Draw("P.hod.starttime >> SHMShodoStartTime", evtCut && eBetaCut && pBetaCut && cerCut && calCut && hodoTimeCut);
    ...
    //tree->Draw("H.hod.starttime >> HMShodoStartTime", evtCut && eBetaCut && pBetaCut && cerCut && calCut && hodoTimeCut);
